...
TBD - captures the team management capability (one-user-one-team constraint, team creation, joining via invite code, member/team info lookup, leaving/team deletion, and non-member access blocking).
