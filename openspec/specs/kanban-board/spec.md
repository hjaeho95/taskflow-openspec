...
TBD - captures the kanban board capability (task listing/filtering, creation, status transitions via drag-and-drop, editing, deletion permissions, and the empty state).
